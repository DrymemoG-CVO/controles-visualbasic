Public Class OtroForm
    Sub asignarmunicipios(departamento)
    ...
    Private Sub ComboBox1_SelectedValueChanged(sender As Object, e As EventArgs) Handles cbdeptos.SelectedValueChanged
        asignarmunicipios(cbdeptos.SelectedItem)
    End Sub
End Class